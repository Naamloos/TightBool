...
{
    /// <summary>
    /// A Struct that tries to store 16 true/false values in a single short.
    /// </summary>
    public struct ShortTightBool
    {
        ...
        /// <summary>
        /// Makes a new ShortTightBool with preset values.
        /// </summary>
        /// <param name="trueindices">Indices for values that should be true.</param>
        public ShortTightBool(params int[] trueindices)
        {
            this.storage = 0;
        ...
        /// <summary>
        /// Creates a ShortTightBool with preset storage.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value from this ShortTightBool
        /// </summary>
